...
//import Foundation
//
//final class EMMonitorController {
//    enum State {
//        case increasing
//        case decreasing
//    }
//    
//    lazy var lastPeakDate = Date()
//    lazy var lastPeakValue = Double(0)
//    lazy var lastDate = Date()
//    lazy var lastValue = Double(0)
//    lazy var maxDiff = Double(-999)
//    lazy var minDiff = Double(999)
//    lazy var previousDiff = Double(0)
//    lazy var data = NSMutableArray(capacity: 0)
//    lazy var state = EMMonitorController.State.increasing
//    lazy var diffState = EMMonitorController.State.increasing
//    lazy var estimatedRate = NSNumber()
//    lazy var incrementCnt = 0
//    lazy var decrementCnt = 0
//    lazy var lastSamples = NSMutableArray(capacity: 0)
//
//    init() {
//        lastSamples = NSMutableArray(capacity: 0)
//    }
//}
//
//
