...
private extension PaygateMapper {
    ...
    static func map(option: [String: Any], productsPrices: [ProductPrice]?, index: Int) -> PaygateOption? {
        ...
        let title = (option["title"] as? String)?
            .attributed(with: TextAttributes()
                .font(Fonts.Poppins.bold(size: 20.scale))
                .lineHeight(25.scale)
                .letterSpacing(0.06)
        ...
        let subCaption = (option["subcaption"] as? String)?
            .attributed(with: TextAttributes()
                .font(Fonts.Poppins.semiBold(size: 10.scale))
                .letterSpacing(0.06)
                .lineHeight(13.scale)
                .textColor(UIColor(integralRed: 17, green: 17, blue: 17)))
        ...
        captionAttrs.addAttributes(TextAttributes().font(Fonts.Poppins.bold(size: index == 0 ? 16.scale : 20.scale)).letterSpacing(0.06).dictionary,
        ...
        bottomLineAttrs.addAttributes(TextAttributes().font(Fonts.Poppins.bold(size: 20.scale)).letterSpacing(-0.08).dictionary,
    ...
    static func map(specialOffer: [String: Any]?, productsPrices: [ProductPrice]?) -> PaygateSpecialOffer? {
        ...
        let title = (specialOffer["subtitle"] as? String)?
            ...
            .attributed(with: TextAttributes()
                .font(Fonts.Poppins.bold(size: 52.scale))
                .textColor(UIColor.white)
                .lineHeight(54.scale)
        ...
        let subButton = (specialOffer["subbutton"] as? String)?
            .replacingOccurrences(of: "@price", with: productPrice.priceLocalized)
            .attributed(with: TextAttributes()
                    .font(Fonts.OpenSans.semiBold(size: 13.scale))
        ...
        let restore = (specialOffer["restore"] as? String ?? "")
            .attributed(with: TextAttributes()
                .font(Fonts.OpenSans.semiBold(size: 17.scale))
                .lineHeight(27.scale)
        ...
        let currentPriceLocalized = currentPrice?
            .attributed(with: TextAttributes()
                .font(Fonts.Poppins.bold(size: 17.scale))
                .lineHeight(19.scale)
                .textColor(.black))
