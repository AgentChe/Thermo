...
final class LAHViewController: UIViewController {
    var loggerView = LAHView()
...
// MARK: Make
extension LAHViewController {
    static func make() -> LAHViewController {
        LAHViewController()
    }
}

// MARK: PaygateViewControllerDelegate
extension LAHViewController: PaygateViewControllerDelegate {
